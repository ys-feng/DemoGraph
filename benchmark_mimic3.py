                    ...
                    for lr in [0.0001, 0.0005, 0.0008, 0.001, 0.003, 0.005, 0.01]:
                        for nc in [0, 25, 50, 75, 100]:
                            try:
                                ...
                                config["name"] = f"MIMIC3_d{d}dim{dim}L{l}h{heads}lr{lr}nc{nc}"
                                dataset_name = config["datasets"]["name"]
                                config["checkpoint"]["path"] = f"./checkpoints/Hyperparameters{dataset_name}/d{d}dim{dim}L{l}h{heads}lr{lr}nc{nc}/"
