                    ...
                    for lr in [
                        ...
                        for nc in [
                            ...
                            try:
                                ...
                                config["name"] = f"MIMIC3_Readm_d{d}dim{dim}L{l}h{heads}lr{lr}nc{nc}"
                                dataset_name = config["datasets"]["name"]
                                config["checkpoint"][
                                    "path"] = f"./checkpoints/HyperparametersReadm{dataset_name}/d{d}dim{dim}L{l}h{heads}lr{lr}nc{nc}/"
