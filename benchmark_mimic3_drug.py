                    ...
                    for lr in [
                        ...
                        for nc in [
                            ...
                            try:
                                ...
                                config["name"] = f"MIMIC3_Drug_d{d}dim{dim}L{l}h{heads}lr{lr}nc{nc}"
                                dataset_name = config["datasets"]["name"]
                                config["checkpoint"][
                                    "path"] = f"./checkpoints/Hyperparameters{dataset_name}Drug/d{d}dim{dim}L{l}h{heads}lr{lr}nc{nc}/"
                                ...
                                print(f"Skipping configuration: d{d}dim{dim}L{l}h{heads}lr{lr}nc{nc}")
                            finally:
                                if trainer:
                                    wandb.finish()
                                    del trainer
...
config_file = "GAT_MIMIC3_drug.yml"
