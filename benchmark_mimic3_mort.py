                    ...
                    for lr in [
                        ...
                        for nc in [
                            ...
                            try:
                                ...
                                config["name"] = f"MIMIC3_Mort_d{d}dim{dim}L{l}h{heads}lr{lr}nc{nc}nec1"
                                dataset_name = config["datasets"]["name"]
                                config["checkpoint"][
                                    "path"] = f"./checkpoints/HyperparametersMort{dataset_name}/d{d}dim{dim}L{l}h{heads}lr{lr}nc{nc}nec1/"
...
config_file = "GAT_MIMIC3_mort.yml"
